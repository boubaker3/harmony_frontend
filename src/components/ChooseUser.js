...
const client = (
  <React.Fragment>
    ...
    <CardActions>
      <Button onClick={()=>{ 
                            dispatch(setAcc("client"))}} size="small">Choose It</Button>
    </CardActions>
  </React.Fragment>);
...
const chef = (
  <React.Fragment>
    ...
    <CardActions>
    <Button onClick={()=>{ 
                          dispatch (setAcc("chef"))}} size="small">Choose It</Button>
    </CardActions>
  </React.Fragment>);
...
const shipper = (
  <React.Fragment>
    ...
    <CardActions>
    <Button onClick={()=>{ 
                          dispatch(setAcc("shipper"))}} size="small">Choose It</Button>
    </CardActions>
  </React.Fragment>);
 ...
 <Typography variant="h6" sx={{color:"var(--yellow)", fontFamily:"Montserrat"  }}  >Signup as a {signupAs}</Typography>
 </Grid>
