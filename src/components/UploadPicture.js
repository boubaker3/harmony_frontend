...
function handleChange(e) {
 ...
 const sendPicture=(event)=>{
        ...
        axios.post("http://localhost:8000/api/updatePicture",{photo:encoded,userid:user.userid}).
        then(response=>{
        navigate("/");
        })
        .catch(error=>{
      ...
      <Grid container>
        ...
        <Box sx={{height:"500px",width:{xs:"450px",sm:"450px",md:"500px",lg:"500px",xl:"500px"},boxShadow:' rgba(149, 157, 165, 0.2) 0px 8px 24px',
         ...
         <Box sx={{height:"200px",position:"absolute",width:{xs:"450px",sm:"450px",md:"500px",lg:"500px",xl:"500px"},
          ...
          <Box sx={{margin: '100px auto',display:"block",width:"150px",height:"150px",backgroundColor:"rgb(241, 241, 241)",borderRadius:"38px"  ,padding:uploaded?"0px":"20px",position:"relative"}}>
 <label for="avatar">
...
<Input sx={{visibility:"hidden"}} type="file"
       id="avatar" name="avatar" onChange={handleFileChange}
       accept="image/png, image/jpeg"></Input>
</Box>
           
          <Grid xs={12}>
    
          <Button type='submit' onClick={sendPicture} disableElevation variant='contained' sx={{width:"250px",paddingLeft:"60px",paddingRight:"60px",  color:"white",borderRadius:"38px"
         ,fontFamily:"Montserrat",fontSize:"18px" ,marginTop:"120px " ,justifyContent:"center", marginLeft: "auto",
         marginRight: "auto",display:"block",textAlign:"center"}}>Upload It</Button>
         </Grid>
