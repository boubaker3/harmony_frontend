    ...
    <>
      ...
      >
        <Chip
          ...
          label={props.restaurent.rating}
        />
        <Avatar
          src={props.restaurent.cover}
          sx={{
        ...
        <CardContent>
          ...
          <Box sx={{}}>
            ...
            <Typography
              sx={{ fontFamily: "Montserrat", color: "gray", fontSize: "16px" }}
              gutterBottom
              variant="h6"
              component="div"
            >
          ...
          <Button
            ...
            to={{
              ...
              search: `?userid=${props.restaurent.userid}`,
            }}
            disableElevation
            variant="contained"
            sx={{
